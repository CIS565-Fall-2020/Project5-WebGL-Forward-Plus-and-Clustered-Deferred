...
export default class ClusteredDeferredRenderer extends BaseRenderer {
        ...
        this._progShade = loadShaderProgram(QuadVertSource, fsSource({
            ...
            maxLights: MAX_LIGHTS_PER_CLUSTER,
                ...
                uniforms: ['u_gbuffers[0]', 'u_gbuffers[1]', 'u_lightbuffer', 'u_clusterbuffer',
                    , 'u_viewMatrix', 'u_viewProjMatInv', 'u_cameraNear', 'u_cameraFar', 'u_screenH', 'u_screenW'
                    , 'u_xSlices', 'u_ySlices', 'u_zSlices', 'u_maxLights', 'u_camPos'],
                attribs: ['a_uv'],
            });
    ...
    render(camera, scene) {
        ...
        let viewProjectionMatInv = mat4.create();
        mat4.invert(viewProjectionMatInv, this._viewProjectionMatrix);
        gl.uniformMatrix4fv(this._progShade.u_viewProjMatInv, false, viewProjectionMatInv);
        ...
        gl.uniform1i(this._progShade.u_maxLights, MAX_LIGHTS_PER_CLUSTER);
