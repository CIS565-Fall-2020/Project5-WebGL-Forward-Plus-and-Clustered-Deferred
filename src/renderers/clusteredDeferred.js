...
export default class ClusteredDeferredRenderer extends BaseRenderer {
  constructor(xSlices, ySlices, zSlices) {
    ...
    this._progShade = loadShaderProgram(QuadVertSource, fsSource({
      ...
      uniforms: ['u_viewMatrix', 'u_viewProjectionMatrix', 'u_inverseViewProjection', 'u_camPos', 'u_zDelta', 'u_lightbuffer', 'u_clusterbuffer', 'u_gbuffers[0]',  'u_gbuffers[1]'],
      attribs: ['a_uv'],
    });
  ...
  render(camera, scene) {
    ...
    let viewProj_inv = mat4.create();
    mat4.invert(viewProj_inv, this._viewProjectionMatrix);
    ...
    gl.uniformMatrix4fv(this._progCopy.u_inverseViewProjection, false, viewProj_inv);
    ...
    this.updateClusters(camera, this._viewMatrix, this._viewProjectionMatrix, scene);
    ...
    gl.uniform1f(this._progShade.u_zDelta, camera.far - camera.near);
