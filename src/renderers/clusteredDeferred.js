...
export default class ClusteredDeferredRenderer extends BaseRenderer {
  ...
  render(camera, scene) {
    ...
    gl.uniform1i(this._progShade.u_MAX_LIGHTS_PER_CLUSTER, MAX_LIGHTS_PER_CLUSTER);
    gl.uniform1i(this._progShade.u_canvas_width, canvas.width);
    gl.uniform1i(this._progShade.u_canvas_height, canvas.height);
