...
export default class ForwardPlusRenderer extends BaseRenderer {
  constructor(xSlices, ySlices, zSlices) {
    ...
    this._shaderProgram = loadShaderProgram(vsSource, fsSource({
      ...
      uniforms: ['u_viewMatrix', 'u_viewProjectionMatrix', 
                  'u_colmap', 'u_normap', 
  ...
  render(camera, scene) {
    ...
    gl.uniform1f(this._shaderProgram.u_screen_w, canvas.width);
    gl.uniform1f(this._shaderProgram.u_screen_h, canvas.height);
    gl.uniform1i(this._shaderProgram.u_slice_x, this._xSlices);
    gl.uniform1i(this._shaderProgram.u_slice_y, this._ySlices);
