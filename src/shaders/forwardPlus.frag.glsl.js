export default function(params) {
  ...
  void main() {
    ...
    int cluster_idx = cluster_x + cluster_y * u_slice_x;
    int maxLightsNum = int(ExtractFloat(u_clusterbuffer, ${params.clusterTextureWidth}, ${params.clusterTextureHeight}, cluster_idx, 0));
